                            ...
                            <form method="GET" action="{{ route('pimpinan.laporan') }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end">
                                        ...
                                        <a href="{{ route('pimpinan.laporan.pdf', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}"
                                    ...
                                    <tbody>
                                        @foreach($suratMasuk as $index => $surat)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($surat->file_surat)
                                                        <a href="{{ route('pimpinan.surat-masuk.download', $surat->id) }}"
                                        ...
                                        @foreach($suratKeluar as $index => $surat)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($surat->file_surat)
                                                        <a href="{{ route('pimpinan.surat-keluar.download', $surat->id) }}"
                                                            class="btn btn-success btn-sm">
                                                            <i class="bi bi-download"></i> Unduh
                                                        </a>
                                                    @else
