...
<head>
    ...
    <!-- Vendor CSS Files -->
    <link rel="stylesheet" href="{{ asset('assets/admin/css/dashboard_admin.css') }}">
...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed{{ request()->routeIs('admin.suratMasuk') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed{{ request()->routeIs('admin.suratKeluar') ? 'active' : '' }}"
                    href="{{route('admin.suratKeluar')}}">
                    <i class="bi bi-envelope-fill"></i>
                    <span>Surat Keluar</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed{{ request()->routeIs('admin.arsipSurat') ? 'active' : '' }}"
                    href="{{route('admin.arsipSurat')}}">
                    <i class="bi bi-layout-text-window-reverse"></i>
                    <span>Arsip Surat</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed{{ request()->routeIs('admin.bidang') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed{{ request()->routeIs('admin.laporan') ? 'active' : '' }}"
