...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        ...
                        <span class=" d-none d-md-block dropdown-toggle ps-2">Pimpinan</span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="{{route('pimpinan.profile')}}">
                        ...
                        <li>
                            <form id="logout-form" action="{{route('pimpinan.logout')}}" method="POST"
                                style="display: none;">
                                @csrf
                            </form>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed{{ request()->routeIs('pimpinan.dashboard') ? 'active' : '' }}"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed{{ request()->routeIs('pimpinan.disposisiSuratMasuk') ? 'active' : '' }}"
                    href="{{route('pimpinan.disposisiSuratMasuk')}}">
                    <i class="bi bi-envelope"></i>
                    <span> Surat Masuk</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed{{ request()->routeIs('pimpinan.disposisiSuratKeluar') ? 'active' : '' }}"
                    href="{{route('pimpinan.disposisiSuratKeluar')}}">
                    <i class="bi bi-envelope"></i>
                    <span> Surat Keluar</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link collapsed{{ request()->routeIs('pimpinan.laporan') ? 'active' : '' }}"
