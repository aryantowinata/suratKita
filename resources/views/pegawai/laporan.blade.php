                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="GET" action="{{ route('pegawai.laporan') }}">
                                <div class="row">
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end">
                                        ...
                                        <a href="{{ route('pegawai.laporan.pdf', ['start_date' => request('start_date'), 'end_date' => request('end_date')]) }}"
                                    ...
                                    <tbody>
                                        @foreach($suratMasuk as $index => $surat)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($surat->file_surat)
                                                        <a href="{{ route('pegawai.surat-masuk.download', $surat->id) }}"
                                        ...
                                        @foreach($suratKeluar as $index => $surat)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($surat->file_surat)
                                                        <a href="{{ route('pegawai.surat-keluar.download', $surat->id) }}"
                                                            class="btn btn-success btn-sm">
                                                            <i class="bi bi-download"></i> Unduh
                                                        </a>
                                                    @else
